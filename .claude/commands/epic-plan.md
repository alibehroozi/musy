---
description: Plan an epic — interview, explore, break into features, write self-contained feature specs under .claude/pending-epics/
---
...
The output is **`.claude/pending-epics/<epic-slug>/`**, committed to the repo. Future sessions read it; nothing is gitignored.

## Output shape

```
.claude/pending-epics/<epic-slug>/
