...
- Blank optional keys (`ANTHROPIC_API_KEY`, `OPENAI_API_KEY`, `AUDIUS_APP_NAME`, `SOUNDCLOUD_USER_AGENT`, etc.) → list as follow-ups the user fills when the relevant feature lands
